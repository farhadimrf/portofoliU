...
import { FileText, Check, Copy, Send } from 'lucide-react';
        ...
        <div className="max-w-3xl mx-auto gothic-card p-8 sm:p-12 rounded-3xl border-[#C5A46D]/35 text-center relative overflow-hidden mb-16 bg-[#141519]/95 shadow-[0_0_40px_rgba(0,0,0,0.8)]">
          <div className="space-y-6">
            ...
            <div className="space-y-1 pb-1 max-w-sm mx-auto">
              <span className="font-mono text-base text-[#C5A46D] uppercase tracking-widest font-bold block">
                MOHAMMADREZA FARHADI
              </span>
              <span className="font-sans text-base text-[#B8B2A7] font-medium block">
            ...
            {/* Tertiary Link Actions Row: GitHub, LinkedIn, Resume (PDF) */}
            <div className="pt-6 border-t border-[rgba(255,255,255,0.08)] flex items-center justify-center gap-3 sm:gap-4 flex-wrap mt-6">
              <a
                href={PERSONAL_INFO.github}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-white/[0.03] border border-white/[0.08] hover:border-[#C5A46D]/40 hover:bg-white/[0.06] text-xs font-mono tracking-wider text-[#B8B2A7] hover:text-[#EAE6DF] transition-all duration-300 group"
              >
                <svg className="w-3.5 h-3.5 text-[#C5A46D] group-hover:scale-110 transition-transform fill-current" viewBox="0 0 24 24">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-white/[0.03] border border-white/[0.08] hover:border-[#C5A46D]/40 hover:bg-white/[0.06] text-xs font-mono tracking-wider text-[#B8B2A7] hover:text-[#EAE6DF] transition-all duration-300 group"
              >
                <FileText className="w-3.5 h-3.5 text-[#C5A46D] group-hover:scale-110 transition-transform" />
